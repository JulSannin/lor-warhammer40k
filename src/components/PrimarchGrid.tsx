...
/**
 * Галерея примархов перед таблицей легионов.
 *
 * Строится из той же таблицы, что стоит следом, — номер, имя, легион и
 * судьба берутся из неё, а портрет подбирается по номеру. Это важно: если
 * правка лора изменит таблицу, галерея изменится вместе с ней, а не
 * разойдётся.
 *
